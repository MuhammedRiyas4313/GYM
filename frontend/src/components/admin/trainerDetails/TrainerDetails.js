     ...
     { confirmationModalShow ? <VerificationModal
      ...
      <div className="md:flex no-wrap md:-mx-2 ">
        ...
        <div className="w-full md:w-9/12 mx-2 h-64">
          ...
          { !trainerDetails.isVerified ? <button onClick={verificationTrainer} className="block w-full text-white text-sm font-semibold rounded-lg hover:bg-blue-900 focus:outline-none focus:shadow-outline focus:bg-blue-600 bg-blue-600 hover:shadow-xs p-3 my-4">
            Verify Trainer
          </button>:<button  className="block w-full text-white text-sm font-semibold rounded-lg  focus:outline-none focus:shadow-outline  bg-green-700  p-3 my-4 disabled:">
            Verified Trainer
          </button>}
        </div>
      </div>
